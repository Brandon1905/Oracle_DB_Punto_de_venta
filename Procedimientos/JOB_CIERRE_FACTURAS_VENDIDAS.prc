...
begin
  ...
  -- ? Se deberá incluir un proceso para realizar los cierres diarios, este cierre se ejecutará 
  -- automáticamente y el resultado se la notificará al coordinador y gerente. (Un cierre 
  -- es necesario, incluir los detalles básicos como fecha, cantidad vendido, devoluciones 
  -- y total, en el detalle del cierre se incluirá el cajero y cantidad vendida y devoluciones) 
