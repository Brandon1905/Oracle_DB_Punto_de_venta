...
is
  ...
  msg_from varchar2(50) := 'brandonsopoti@gmail.com';-----Type Your Gmail Email ID in encoded Format----
...
BEGIN
  ...
  mail_conn := utl_smtp.open_connection(mailhost, 587,wallet_path => 'file:C:\app\Brandon\product\18.0.0\admin\XE\wallet'/*Your Wallet Path*/,wallet_password => 'Oracle123'/* Your Wallet Password*/
  ,secure_connection_before_smtp => false);
  utl_smtp.ehlo(mail_conn,'smtp.gmail.com');
  utl_smtp.starttls(mail_conn);
  utl_smtp.command(mail_conn, 'AUTH LOGIN');
  utl_smtp.command(mail_conn, 'YnJhbmRvbnNvcG90aUBnbWFpbC5jb20='); --Type Your Gmail Email ID in encoded Format----
